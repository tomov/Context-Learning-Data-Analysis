function [table_Rho, table_P, all_subject_rhos, idx, x, y, z] = rdms_searchlight_collins(start_idx, end_idx, r)
...
%% Get the model RDMs
%
[Model, control_model_idxs] = rdms_get_model_collins(data, metadata, which_rows);
