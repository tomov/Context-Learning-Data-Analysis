function betas = get_betas(mask, regressor_prefix, data, metadata)
...
betas_filename = fullfile('betas', ['betas_', regressor_prefix, '_', maskname, '.mat']);
...
if exist(betas_filename, 'file') ~= 2
    ...
    betas = load_betas(mask, regressor_prefix, data, metadata);
