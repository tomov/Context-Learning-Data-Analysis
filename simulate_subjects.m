    ...
    for condition = unique(data.contextRole)'
        ...
        for run = runs
            ...
            elseif isequal(which_structures, 'simple_collins')
                ...
                simulated.priors_Zc_and_C(:,:,which_train) = train_results.priors_Zc_and_C;
                simulated.priors_Zs_and_S(:,:,which_train) = train_results.priors_Zs_and_S;
                simulated.priors_Zc(which_train,:) = train_results.priors_Zc;
                simulated.priors_Zs(which_train,:) = train_results.priors_Zs;
                ...
                simulated.posteriors_Zc_and_C(:,:,which_train) = train_results.posteriors_Zc_and_C;
                simulated.posteriors_Zs_and_S(:,:,which_train) = train_results.posteriors_Zs_and_S;
                simulated.posteriors_Zc(which_train,:) = train_results.posteriors_Zc;
                simulated.posteriors_Zs(which_train,:) = train_results.posteriors_Zs;
            ...
            elseif isequal(which_structures, 'ideal')
                ...
                num_particles = 1;
                init_fn = @() ideal_init(train_x, train_k, train_r, subject_params, [1 1 0 1 0], false);
                choice_fn = @(n, particle) ideal_choice(n, particle, train_x, train_k, train_r, train_a, subject_params, [1 1 0 1 0], false);
                update_fn = @(n, particle) ideal_update(n, particle, train_x, train_k, train_r, subject_params, [1 1 0 1 0], false);
            ...
            elseif isequal(which_structures, 'MCMC_neurath2')
                ...
                init_fn = @() MCMC_neurath_init(train_x, train_k, train_r, subject_params, [1 1 0 1 0], false);
                choice_fn = @(n, particle) MCMC_neurath_choice(n, particle, train_x, train_k, train_r, train_a, subject_params, [1 1 0 1 0], false);
                update_fn = @(n, particle) MCMC_neurath2_update(n, particle, train_x, train_k, train_r, subject_params, [1 1 0 1 0], false);
