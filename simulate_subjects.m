    ...
    for condition = unique(data.contextRole)'
        ...
        for run = runs
            ...
            elseif isequal(which_structures, 'simple_collins') % TODO fixme  reviewer 2
                ...
                simulated.priors_P_Zc_and_C(:,:,which_train) = train_results.priors_P_Zc_and_C;
                simulated.priors_P_Zs_and_S(:,:,which_train) = train_results.priors_P_Zs_and_S;
                simulated.priors_P_Zc(which_train,:) = train_results.priors_P_Zc;
                simulated.priors_P_Zs(which_train,:) = train_results.priors_P_Zs;
                simulated.priors_P_C(which_train,:) = train_results.priors_P_C;
                simulated.priors_P_S(which_train,:) = train_results.priors_P_S;
                ...
                simulated.posteriors_P_Zc_and_C(:,:,which_train) = train_results.posteriors_P_Zc_and_C;
                simulated.posteriors_P_Zs_and_S(:,:,which_train) = train_results.posteriors_P_Zs_and_S;
                simulated.posteriors_P_Zc(which_train,:) = train_results.posteriors_P_Zc;
                simulated.posteriors_P_Zs(which_train,:) = train_results.posteriors_P_Zs;
                simulated.posteriors_P_C(which_train,:) = train_results.posteriors_P_C;
                simulated.posteriors_P_S(which_train,:) = train_results.posteriors_P_S;
