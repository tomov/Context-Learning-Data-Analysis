function train_results = q_train(x, k, r, params, DO_PRINT)
% same as model_train but for Q-learning model proposed by reviewer #1
...
for n = 1:N % for each trial
    ...
    Q(s,a) = r_n; % deterministic TODO learning rate -- free parameter
